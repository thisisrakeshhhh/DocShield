  ...
  return (
    <footer className="w-full border-t border-gray-300 shadow-inner bg-[var(--bg-color)] text-[var(--text-color)] py-6 px-4 flex flex-col md:flex-row items-center justify-between">
      ...
      <div className="flex items-center gap-4 mt-4 md:mt-0">
        {/* LinkedIn */}
        <a
          href="https://www.linkedin.com/in/rakesh-641958256"
          target="_blank"
        ...
        {/* GitHub */}
        <a
          href="https://github.com/thisisrakeshhhh"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:scale-110 transition-transform"
        >
        ...
        {/* Instagram */}
        <a
          href="https://instagram.com/thisisrakesh"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:scale-110 transition-transform"
        >
        ...
        {/* Email */}
        <a
          href="mailto:youknowmeasrakesh@gmail.com"
          className="hover:scale-110 transition-transform"
        >
          <img
